    ...
    >
            ...
            <Card variant="featured" className="h-full justify-between">
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 mb-4">
                  <span className="text-label font-bold uppercase tracking-[0.16em] px-3 py-1 rounded-full bg-spidey-blue/30 text-blue-300 border border-spidey-blue/50">
                    {problem.domain}
                  </span>
                  <span className="text-label font-bold uppercase tracking-[0.16em] px-3 py-1 rounded-full bg-spidey-red/20 text-spidey-red border border-spidey-red/40">
                    {problem.sponsorTag}
                  </span>
                </div>

                {/* Title */}
                <h3 className="text-display-md font-bold text-web-white leading-snug">
                  {problem.title}
                </h3>

                {/* Description */}
                <p className="mt-3.5 text-white/75 text-body-sm sm:text-body-base leading-relaxed max-w-prose">
                  {problem.description}
                </p>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-caption-xs sm:text-caption-sm font-bold uppercase tracking-wider text-spidey-red hover:text-web-white transition-colors group"
                >
      ...
      <div className="mt-12">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-6 sm:mb-8">
          <h3 className="text-heading-sm sm:text-heading-md font-bold uppercase tracking-wider text-web-white">
            EXPLORE ALL DOMAINS
          </h3>
          <span className="text-caption-xs font-semibold uppercase tracking-widest text-web-gray">
              ...
              <Card variant="domain" className="h-full justify-between">
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-caption-xs font-bold uppercase tracking-widest text-spidey-red">
                      {domain.domain}
                    </span>
                    <span className="text-[10px] uppercase font-bold text-web-gray/80 px-2 py-0.5 rounded bg-white/5 border border-white/10">
                      {domain.id.toUpperCase()}
                    </span>
                  </div>
                  <h4 className="font-bold text-body-base sm:text-heading-sm text-web-white leading-snug">
                    {domain.title}
                  </h4>
                  <p className="text-body-sm text-web-gray mt-2 line-clamp-2 leading-relaxed">
                    {domain.description}
                  </p>
                </div>
                ...
                <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-end">
                  <Link
                    ...
                    className="text-caption-xs font-semibold uppercase tracking-wider text-web-gray hover:text-spidey-red transition-colors inline-flex items-center gap-1"
                  >
