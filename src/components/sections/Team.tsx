  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16 sm:mb-20">
        <h2 className="section-heading text-display-lg leading-tight">ORGANIZERS</h2>
        ...
        <p className="text-white/75 font-body text-body-base sm:text-body-lg max-w-2xl mx-auto leading-relaxed font-normal">
          Meet the organizers bringing Srijan Setu from an idea to a shared experience for every builder.
        </p>
      </div>

      <TeamMemberGrid members={team.filter((member) => member.tier === "organizers")} />
